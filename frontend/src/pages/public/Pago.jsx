...
const Pago = () => {
  ...
  const handleSubmit = (event) => {
    ...
    setTimeout(() => {
      ...
      navigate(`/confirmacion?producto=${productoId}`);
    }, 1500);
  };
      ...
      <main className="pago-page">
        <section className="pago-container">
          <div className="pago-header">
            ...
            <span>Seleccioná un método de pago para continuar.</span>
          </div>
          ...
          <form className="pago-form" onSubmit={handleSubmit}>
            ...
            <button type="submit" className="pago-button" disabled={procesando}>
              {procesando ? "Procesando pago..." : "Pagar"}
            </button>
          </form>

          <Link to="/catalogo" className="pago-back">
            Volver al catálogo
          </Link>
        </section>
      </main>
