    ...
    <>
      ...
      <main className="bg-white">
        ...
        <section className="bg-[#e5e5e5]">
          ...
          <div className="mx-auto grid min-h-[420px] max-w-7xl items-center gap-10 px-6 py-12 md:grid-cols-2 md:px-8 md:py-16 lg:px-10">

            {/* TEXTO */}

            <div className="text-center md:text-left">

              <p className="mb-3 text-xs font-semibold uppercase tracking-[0.2em] text-[#a86620]">
                Nueva colección
              </p>
              ...
              <p className="mx-auto mb-7 max-w-md text-sm leading-6 text-gray-600 md:mx-0">
                Descubrí la nueva colección NORTE y
                encontrá prendas pensadas para todos
                los días.
              </p>

              <Link
                to="/catalogo"
                className="inline-flex rounded-md bg-[#a86620] px-6 py-3 text-xs font-medium text-white transition hover:-translate-y-0.5 hover:bg-[#8e571b]"
              >
                Ver catálogo
              </Link>
            ...
            <div className="flex h-[280px] w-full items-center justify-center overflow-hidden md:h-[350px]">
              ...
              return (
                ...
                >
                  ...
                  <div className="p-5 text-center">
                    ...
                    <p className="mt-1 text-xs text-gray-500 transition group-hover:text-[#a86620]">
                      Ver colección
                    </p>
        ...
        <section className="border-t border-gray-200 bg-[#f7f7f7]">
          ...
          <div className="mx-auto flex max-w-7xl flex-col items-center px-6 py-14 text-center md:px-8 md:py-16 lg:px-10">
            ...
            <p className="mt-3 max-w-lg text-sm leading-6 text-gray-500">
              Explorá nuestro catálogo y descubrí
              prendas para acompañarte todos los días.
            </p>

            <Link
              to="/catalogo"
              className="mt-7 inline-flex rounded-md border border-[#a86620] px-6 py-3 text-xs font-medium text-[#a86620] transition hover:bg-[#a86620] hover:text-white"
            >
              Explorar catálogo
            </Link>
